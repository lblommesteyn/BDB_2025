...
def feature_vector_from_play(result: Dict, heuristics: Dict[str, float]) -> np.ndarray:
    values = [
        ...
        result.get("peak_collapse_rate", 0.0),
        result.get("time_to_50pct", 0.0),
        result.get("ce_final_norm", 0.0),
        result.get("bfoi", 0.0),
        result.get("coverage_intensity", 0.0),
        result.get("pursuit_eff_mean", 0.0),
        result.get("hrt_mean", 0.0),
        result.get("arrival_mean", 0.0),
    ]
